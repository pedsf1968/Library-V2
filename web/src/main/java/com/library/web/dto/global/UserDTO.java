package com.library.web.dto.global;
...
public class UserDTO implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return getId().equals(userDTO.getId()) &&
              ...
              getStreet1().equals(userDTO.getStreet1()) &&
              getZipCode().equals(userDTO.getZipCode()) &&
              getCity().equals(userDTO.getCity()) &&
              getCountry().equals(userDTO.getCountry());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getId(), getFirstName(), getLastName(), getPassword(), getMatchingPassword(), getEmail(), getPhone(), getPhotoLink(), getStatus(), getCounter(), getRoles(), getStreet1(), getStreet2(), getStreet3(), getZipCode(), getCity(), getCountry());
    }
