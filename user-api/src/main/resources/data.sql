...
VALUES (1,'Admin','ADMIN',null,'admin@library.org','$2a$10$iyH.Uiv1Rx67gBdEXIabqOHPzxBsfpjmC0zM9JMs6i4tU0ymvZZie', 2, 'MEMBER','22, rue de la Paix','75111','Paris'),
    ...
    (5,'Victor','HUGO','','victor.hugo@gmail.com','$2a$10$vEUHdcii.3Q/wRA/CxRpk.bJ8m5VA8qS0TQcMWVros.wSaggG32Vi', 0, 'MEMBER', '24, Rue des cannut','69003','Lyon');

-- user-roles insertion
INSERT INTO users_roles (user_id,role_id)
VALUES (1,1),(1,2),(1,3),(2,2),(2,3),(3,3),(4,3),(5,3);
